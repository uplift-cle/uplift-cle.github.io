          ...
          <div className="container px-4 md:px-6 mx-auto">
            <Card className="max-w-2xl mx-auto border-slate-200 shadow-lg">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-slate-900">Donation Platform Coming Soon</CardTitle>
              </CardHeader>
        ...
        <section className="w-full py-16 md:py-24 bg-slate-50">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Your Support Will Help</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Community Programs</h3>
              ...
              <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Research & Data</h3>
                  <p className="text-slate-600 text-sm">
              ...
              <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Team Growth</h3>
                  <p className="text-slate-600 text-sm">
