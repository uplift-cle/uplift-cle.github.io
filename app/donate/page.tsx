                ...
                <MotionSection className="w-full py-16 md:py-24 text-white border-b">
                    <div className="container px-4 md:px-6 mx-auto text-center">
                        ...
                        <p className="mx-auto max-w-[700px] text-slate-300 text-lg">
                            Help us uplift Cleveland communities through your
                            generous support. Every contribution makes a
                        ...
                        <Card className="max-w-2xl mx-auto border-slate-200 shadow-lg">
                            ...
                            <CardContent className="text-center space-y-6">
                                ...
                                <p className="text-white/80 text-lg">
                                    Secure payments powered by Stripe. Choose
                                    your amount and proceed to checkout.
                                </p>
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-white/80 max-w-2xl mx-auto text-lg">
                                Your contributions support these key areas of
                                our mission.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-white/80 text-sm">
                                        Direct support for community health,
                            ...
                            <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-white/80 text-sm">
                                        Funding for evidence-based research that
                                        informs our community interventions.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-white/80 text-sm">
                                        Technology and operational support to
                                        scale our impact across Cleveland.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-slate-200 hover:shadow-lg transition-shadow">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-white/80 text-sm">
                                        ...
                                        communities and increase our impact.
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
