                ...
                <section className="w-full py-16 md:py-24 text-white">
                    ...
                    <div className="container px-4 md:px-6 mx-auto text-center">
                        ...
                        <p className="mx-auto max-w-[700px] text-slate-300 text-lg">
                            Your generous contribution helps us uplift
                            Cleveland’s communities. A confirmation email has
                            been sent to you.
                        </p>
                    </div>
                    <Button
                        asChild
                        className="bg-green-600 hover:bg-green-700 pt-4 pb-4 px-8 mt-8"
                    >
