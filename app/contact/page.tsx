                ...
                <MotionSection className="w-full py-16 md:py-24 text-white border-b">
                    <div className="container px-4 md:px-6 mx-auto text-center">
                        ...
                        <p className="mx-auto max-w-[900px] text-slate-300 text-lg">
                            ...
                            Reach out to learn more about our work or explore
                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <p className="text-slate-300 text-lg leading-relaxed mb-8">
                                        Whether you're interested in partnering
                                        with us, volunteering your time, or
                                        simply learning more about our work,
                                        we're here to help. Our team is
                                        committed to building meaningful
                                        relationships with everyone who shares
                                        our vision for a better Cleveland.
                                    </p>
                                </div>
