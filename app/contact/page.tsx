                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" placeholder="Your first name" className=" text-white border-slate-600 placeholder-slate-400" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName" className="text-slate-200">Last Name</Label>
                      <Input id="lastName" placeholder="Your last name" className=" text-white border-slate-600 placeholder-slate-400" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-slate-200">Email</Label>
                    <Input id="email" type="email" placeholder="your.email@example.com" className=" text-white border-slate-600 placeholder-slate-400" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-slate-200">Phone Number</Label>
                    <Input id="phone" type="tel" placeholder="(216) 555-0123" className=" text-white border-slate-600 placeholder-slate-400" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="reason" className="text-slate-200">Reason for Contact</Label>
                    <Select>
                      <SelectTrigger className=" text-white border-slate-600">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      rows={5}
                      className=" text-white border-slate-600 placeholder-slate-400"
                    />
                  </div>
