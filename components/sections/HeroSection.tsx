...
export default function HeroSection() {
    return (
        <section className="w-full min-h-screen z-10 py-28 md:py-24 lg:py-52">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-14">
                    ...
                    >
                        ...
                        <p className="mx-auto max-w-[700px] text-white text-lg sm:text-xl">
                            Addressing acute, systemic issues within Cleveland
                            through innovative, interdisciplinary, and
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center items-center">
                        <div className="absolute top-0 w-0 h-0 overflow-hidden rounded-b-[10rem] bg-green-900 lg:w-[35rem] lg:h-[37rem]">
                            <Lottie
                                ...
                                loop={false}
                                className="absolute w-[45rem] left-[-5rem] bottom-[-12rem]"
                            />
                        </div>
                    </div>
                </div>
